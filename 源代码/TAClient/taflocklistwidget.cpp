...
TAFlockListWidget::TAFlockListWidget(TAMainWidget *mainWidget, QWidget *parent) :
...
void TAFlockListWidget::addItem(QWidget *item)
{
...
void TAFlockListWidget::removeItem(QWidget *item)
{
...
void TAFlockListWidget::creatMenu()
{
...
void TAFlockListWidget::showMenu()
 {
    if (m_menu == NULL)
    {
        creatMenu();
...
void TAFlockListWidget::mousePressEvent(QMouseEvent *event)
{
