...
TAMessageWidget::TAMessageWidget(TAMainWidget * mainWidget, QWidget *parent) :
...
TAMessageWidget::~TAMessageWidget()
{
}
void TAMessageWidget::setListModelGroup(const QStringList & groupList)
{
    m_modelGroup->setStringList(groupList);
}
void TAMessageWidget::setListModelGroup()
{
    m_groupList = m_mainWidget->getGroupList();
    m_modelGroup->setStringList(m_groupList);
}
void TAMessageWidget::setListModelFriend(const QStringList & friendList)
{
    m_modelFriend->setStringList(friendList);
}
void TAMessageWidget::setListModelFriend(const QString & groupName)
{
    m_friendList = m_mainWidget->getGroupFriendList(groupName);
    m_modelFriend->setStringList(m_friendList);
}
void TAMessageWidget::setShowMode(Mode mode)
{
    if (mode == LOCAL)
    {
...
void TAMessageWidget::setMessageShow(const QVector<TalkMessage> & mesVec)
{
...
void TAMessageWidget::groupItemClicked(const QModelIndex & index)
{
    setListModelFriend(index.data().toString());
}
void TAMessageWidget::friendItemClicked(const QModelIndex & index)
{
...
void TAMessageWidget::initTAMessageWidget()
{
    /*********************顶部**************************/
...
void TAMessageWidget::linkSignalWithSlot()
{
