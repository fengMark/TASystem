...
TANetWorkMessageWidget::TANetWorkMessageWidget(TAMainWidget *mainWidget,
                                               QWidget *parent) :
...
TANetWorkMessageWidget::~TANetWorkMessageWidget()
{
}
...
*************************************************/
void TANetWorkMessageWidget::onClickDeleteDate()
{
}
...
*************************************************/
void TANetWorkMessageWidget::onClickDeleteOne()
{
}
...
*************************************************/
void TANetWorkMessageWidget::onClickDeleteAll()
{
}
...
*************************************************/
void TANetWorkMessageWidget::onClickExportOne()
{
...
*************************************************/
void TANetWorkMessageWidget::onClickExportAll()
{
...
Description:  获取消息记录
*************************************************/
void TANetWorkMessageWidget::onClickGetMessage()
{
     int row = m_listViewFriend->currentIndex().row();
     if (row < 0)
     {
...
//Description:  单击好友列表项
//*************************************************/
//void TANetWorkMessageWidget::friendItemClicked(const QModelIndex & index)
//{
